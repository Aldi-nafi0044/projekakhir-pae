...
import com.projek.ini.projek.exceptions.NonexistentEntityException;
import com.projek.ini.projek.exceptions.PreexistingEntityException;
...
public class DataJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("com.projek_ini.projek_jar_0.0.1-SNAPSHOTPU");
